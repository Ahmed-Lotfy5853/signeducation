...
'عند دخولك للبرنامج اضغط علي زر ابدا للدخول الي البرنامج و التصفح ',
'البرنامج يتكون من 3 مستويات كل مستوي ملون بلون مختلف للتميز بينهم',
'هناك شريط سفلي في البرنامج لسهولة التصفح والحركة به',
'يوجد بالشريط السفلي زر الرجوع و زر الواجهة الرئيسية و زر المساعدة للتسهيل علي الطلاب',
'المستوي الأول يحتوي علي مستويين الاحرف و الأرقام',
'عند دخولك المستوي الأول يكون هناك اطار الشاشة و الازرار باللون البرتقالي',
'عند الضغط علي الزر و التعلم يتحول الزر من البرتقالي الي الأخضر و اللون الأخضر علامة علي إتمام التعلم',
'عند إتمام التعلم بكامل يتحول اطار الشاشة من البرتقالي الي الأخضر دليل علي إتمام التعلم القسم بالكامل',
'القسم المتوسط و القسم المتطور مغلقين و لا يمكن فتحهم الا عند إتمام القسم الابتدائي',
'عند إتمام تعلم القسم الابتدائي يتم فتح القسم المتوسط',
'عند إتمام القسم الابتدائي و المتوسط تم فتح القسم المتطور ',
];
